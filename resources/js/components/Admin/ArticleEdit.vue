		...
		c0,26.561-21.523,48.085-48.086,48.085C388.725,236.058,367.201,214.533,367.201,187.972z"
            ...
            <div>
              <div
                ...
                class="w-1/2 bg-gray-700 ml-auto mr-auto text-white h-screen p-5 focus:outline-none shadow-2xl rounded-sm"
...
export default {
  ...
  methods: {
    ...
    updateArticle() {
      ...
      this.article.content = content.innerHTML;
      this.article.status = this.currentStatus;

      axios
        .put(`/admin/article/${this.article.id}/edit`, this.article)
        .then((response) => {
  ...
  created() {
    this.currentStatus = this.article.status;
  },
};
</script>
<style scoped>
