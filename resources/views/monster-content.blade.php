...
<h1 class="text-gray-700 text-3xl uppercase font-bold tracking-widest border-b-2 border-green-200 border-dashed"># Monster</h1>


<div class="container shadow-md p-10 leading-10 tracking-wide font-light text-justify">
    <center>
      {!! html_entity_decode($monster->content) !!}
    </center>
</div>
